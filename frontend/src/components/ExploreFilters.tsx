              ...
              {timeFilters.map((time) => (
                <button
                  ...
                  className={cn(
                    ...
                    activeTime === time ? "bg-secondary text-foreground" : "text-muted-foreground hover:text-foreground"
                  )}
                >
                  {time}
                </button>
            ...
            <div className="flex flex-wrap gap-2">
              {sortOptions.map((sort) => (
                <button
                  ...
                  className={cn(
                    "px-3 py-1 rounded-md text-xs transition-colors",
                    activeSort === sort ? "bg-secondary text-foreground" : "text-muted-foreground hover:text-foreground"
                  )}
                >
                  {sort}
                </button>
