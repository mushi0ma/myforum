  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <div
          className="rounded-lg border border-border bg-[var(--color-dark-1)] p-4 max-w-lg overflow-x-auto"
          style={{ fontSize: `${appearance.fontSize}px` }}
        >
          <pre className="font-mono text-foreground">
            {appearance.lineNumbers && <span className="text-muted-foreground mr-4 select-none">1</span>}
            ...
            <span className="text-foreground">{" {"}</span>
            {"\n"}
            {appearance.lineNumbers && <span className="text-muted-foreground mr-4 select-none">2</span>}
            {"  "}
            <span className="text-[#ff7b72]">return</span> <span className="text-[#a5d6ff]">{"`Hello, ${name}!`"}</span>
            <span className="text-foreground">;</span>
            {"\n"}
            {appearance.lineNumbers && <span className="text-muted-foreground mr-4 select-none">3</span>}
            <span className="text-foreground">{"}"}</span>
          </pre>
        </div>
      </div>
