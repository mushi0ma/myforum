      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="bg-card/80 backdrop-blur-sm border border-border rounded-xl p-8 shadow-2xl">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex items-center justify-between mb-7">
                <label className="flex items-center gap-2.5 text-foreground text-sm cursor-pointer group">
                  <input
                    type="checkbox"
                    checked={rememberMe}
                    onChange={(e) => setRememberMe(e.target.checked)}
                    className="w-4 h-4 bg-background border-2 border-border rounded cursor-pointer accent-primary focus:ring-2 focus:ring-primary/30 focus:ring-offset-0"
                  />
                  <span className="group-hover:text-primary transition-colors select-none">
                    Запомнить меня
                  </span>
                </label>
                <a href="#" className="text-primary text-sm hover:text-muted-foreground transition-colors font-medium">
                  Забыли пароль?
                </a>
              </div>
              ...
              >
                ...
                <span className="relative z-10">{isSubmitting ? 'Вход...' : 'Войти'}</span>
              </button>
            </form>
          ...
          <div className="text-center text-sm mt-5">
            ...
            <Link to="/register" className="text-primary hover:text-muted-foreground transition-colors font-medium hover:underline">
              Зарегистрироваться
            </Link>
          </div>
