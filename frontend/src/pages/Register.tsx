...
export default function Register() {
  ...
  const validateEmail = (email: string): boolean => {
    ...
    // - Стандартные: user@example.com
    // - С точками: first.last@example.com
    // - С плюсами: user+tag@example.com
    // - С дефисами: user-name@example.com
    // - Поддомены: user@mail.example.com
    // - Новые TLD: user@example.technology
    // - Цифры: user123@example.com
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#1a1d1f]/80 backdrop-blur-sm border border-[#333637] rounded-xl p-8 shadow-2xl">
            ...
            <div className="mb-4">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-[#000000] border border-[#333637] rounded-lg pl-12 pr-4 py-3.5 text-[#ffffff] placeholder-[#656869] focus:outline-none focus:border-[#58a6ff] focus:ring-2 focus:ring-[#58a6ff]/30 transition-all"
                />
              </div>
            </div>
            ...
            <div className="mb-4 relative">
              ...
              {password && !allRequirementsMet && !showPasswordHint && (
                <p className="text-[#da3633] text-xs mt-1.5 flex items-center gap-1">
                  <AlertCircle size={12} />
            ...
            <div className="mb-5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full bg-[#000000] border rounded-lg pl-12 pr-12 py-3.5 text-[#ffffff] placeholder-[#656869] focus:outline-none transition-all ${
            ...
            >
              ...
              <span className={`absolute inset-0 bg-gradient-to-r from-[#58a6ff] to-[#3fb950] transform origin-left transition-transform duration-700 ${isRegistering ? 'scale-x-100' : 'scale-x-0'}`}></span>
              <span className="relative z-10">{isRegistering ? 'Регистрация...' : 'Зарегистрироваться'}</span>
            </button>
